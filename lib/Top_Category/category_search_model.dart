...
class CategorySearch {
  ...
  factory CategorySearch.fromJson(Map<String, dynamic> json) => CategorySearch(
    ...
    categoriesTree: List<Categor>.from(json["categories_tree"].map((x) => Categor.fromJson(x))),
    categories: List<Categor>.from(json["categories"].map((x) => Categor.fromJson(x))),
    customFields: Map.from(json["custom_fields"]).map((k, v) => MapEntry<String, CustomFieldValue>(k, CustomFieldValue.fromJson(v))),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "categories_tree": List<dynamic>.from(categoriesTree.map((x) => x.toJson())),
...
class Categor {
  ...
  factory Categor.fromJson(Map<String, dynamic> json) => Categor(
    ...
    customFields: List<CategoryCustomField>.from(json["custom_fields"].map((x) => CategoryCustomField.fromJson(x))),
...
class Child {
  ...
  factory Child.fromJson(Map<String, dynamic> json) => Child(
    ...
    catLink: json["cat_link"],
    customFields: List<CustomFieldValue>.from(json["custom_fields"].map((x) => CustomFieldValue.fromJson(x))),
  );
