    ...
    class _CarFilterScreenState extends State<CarFilterScreen> {
      ...
      Widget build(BuildContext context) {
        return Scaffold(
          ...
          body:   currentSelectedByaCar == buyACar
            ...
            child: Column(
              children: [
                ...
                Padding(
                  padding:
                  const EdgeInsets.only(left: 0.0, bottom: 5, top: 15),
                  child: Row(
                    ...
                    child: Container(
                      ...
                      child: SearchableDropdown(
                        ...
                        items: carController
                            ...
                            .map((e) {
                          return DropdownMenuItem(
                            child: Text("${e.cityName},${e.state}",style: TextStyle(fontSize: 15),),
                            value: e.cityName,
                          );
                        }).toList(),
