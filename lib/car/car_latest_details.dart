...
class CarLatestDetails extends StatelessWidget {
  final String image;
  final String title;
  final String price;
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        Padding(
          ...
          //       child: Row(
          //         children: [
          //           Image.asset("assets/images/review.jpg",height: 40,width: 50,),
          //
          //
          //         ],
          //       ),
          ...
          //             spacing:0.0
          //         ),
          //         Text("March 17, 2021",style: TextStyle(fontSize: 15),),
          //
          //       ],
          //     ),
          //   ],
          ...
          // Padding(
          //   padding: const EdgeInsets.only(left:12.0),
          //   child: Text(" To write a review, you must login first.",style: TextStyle(fontSize: 15),),
          // ),
          // SizedBox(height: 15,),
